    ...
    return (
      <div className="p-8 max-w-3xl mx-auto">
        <EmptyState
          ...
          action={<Link href="/dashboard" className="inline-flex items-center gap-2 px-4 py-2 bg-surface border border-border rounded-lg text-sm text-foreground hover:bg-border transition-colors">Back to Dashboard</Link>}
        />
      </div>
    );
  }
  ...
  return (
    <div className="p-6 sm:p-8 max-w-5xl mx-auto pb-24">
      ...
      <div className="text-center mt-8">
        <Link href="/dashboard" className="inline-flex items-center gap-2 px-4 py-2 bg-surface border border-border rounded-lg text-sm text-muted hover:text-foreground hover:bg-border transition-colors">Back to Dashboard</Link>
      </div>
    </div>
  );
}
